        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntitledPaidLeaveDays = table.Column<int>(type: "int", nullable: true),
                    AvailablePaidLeaveDays = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("31b823d5-118c-4f39-b700-cfa2fb32bd98"), "Human Resource" },
                    { new Guid("3610c8a2-dd6e-43f2-8610-eedbd79ef643"), "Software Developer" },
                    { new Guid("8f022a00-bc26-447b-b7f6-6dbdfddd4499"), "Administrator" }
                });
